...
El gripper está compuesto por una pieza impresa en 3D que fue modelada en Autodesk Inventor. Esta pieza funciona como adaptador entre el acople del robot y la ventosa de succión. El diseño mecánico se realizó tomando como referencia la geometría del flache  T3-401S, que cuenta con dos abrazaderas y orificios roscados tipo **M3**. El acople impreso replica esa distribución, permitiendo fijarlo directamente con dos tornillos.  
